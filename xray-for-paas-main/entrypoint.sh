...
UUID=${UUID:-'8fa164e4-0c07-494a-8516-dd5e709724d3'}
VMESS_WSPATH=${VMESS_WSPATH:-'/8fa164e4-0c07-494a-8516-dd5e709724d3-/vmess'}
VLESS_WSPATH=${VLESS_WSPATH:-'/8fa164e4-0c07-494a-8516-dd5e709724d3-/vless'}
TROJAN_WSPATH=${TROJAN_WSPATH:-'/8fa164e4-0c07-494a-8516-dd5e709724d3-/trojan'}
SS_WSPATH=${SS_WSPATH:-'/8fa164e4-0c07-494a-8516-dd5e709724d3-/shadowsocks'}
